...
router.get(
  ...
  studentAwardController.getAllStudentAwardSubmissions
);
router.get(
  "/:id",
  auth(USER_ROLE.super_admin, USER_ROLE.admin, USER_ROLE.moderator),
  studentAwardController.getSingleStudentAwardSubmission
);
router.delete(
  "/:id",
  auth(USER_ROLE.super_admin, USER_ROLE.admin),
  studentAwardController.deleteStudentAwardSubmission
);
